...
```javascript
var fc = ee.FeatureCollection("projects/imars-ee/assets/YOUR_ASSET_NAME_HERE")
...
Links for direct access to tables already uploaded into GEE coming soon.

Source code for this site and analysis can be found [here](https://github.com/7yl4r/rvc_habitat_cover).